			...
			<div class="menu" id="myMenu">
				<div class="wrapperMenu w90">
					...
					<ul>
						...
						<li><a <?php selecionadoMenu('cadastrar-noticia'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>cadastrar-noticia"><i class="myGit" data-feather="download-cloud"></i> Cadastrar Notícia</a></li>
					</ul>
					<h2>Gestão</h2>
					<ul>
					...
					<ul>
						<li><a <?php selecionadoMenu('gerenciar-noticias'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-noticias"><i class="myGit" data-feather="archive"></i> Gerenciar Notícias</a></li>
						<li><a <?php selecionadoMenu('gerenciar-categorias'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-categorias"><i class="myGit" data-feather="bar-chart-2"></i> Gerenciar Categorias</a></li>
						<li><a <?php selecionadoMenu('cadastrar-categorias'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>cadastrar-categorias"><i class="myGit" data-feather="edit"></i> Cadastrar Categorias</a></li>
					</ul>
			...
			<div class="wrap grid-5x5">
				...
				<div class="row">
					<div class="userIcons items-flex w60Mobile">
						...
						<a class="btnIcon" href="<?php echo INCLUDE_PATH_PAINEL ?>home/#myChart"><i class="iconUser" data-feather="bar-chart"></i></a>
